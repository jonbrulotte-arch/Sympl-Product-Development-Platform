...
export const productSchema = z.object({
  ...
  batteriesRequired: z.string().nullish(),
  packagingType: z.string().nullish(),
  packagingLangType: z.string().nullish(),
  ...
  altCartonGtin: z.string().nullish(),
  altCartonType: z.string().nullish(),
  altCartonHeight: optNum,
  altCartonWidth: optNum,
  altCartonLength: optNum,
  altCartonWeight: optNum,
  altCartonQty: optInt,
