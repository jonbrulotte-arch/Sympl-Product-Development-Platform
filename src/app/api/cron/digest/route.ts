...
import { sendMail, wrap, BASE_URL } from "@/lib/email";
...
async function buildDigestHtml(): Promise<string> {
  ...
  return wrap("Weekly Digest", `
    ...
    <p style="font-size:11px;color:#999;margin-top:32px">Generated by Sympl PM.</p>
    <a href="${BASE_URL}/dashboard" style="display:inline-block;margin:8px 0 0;background:#1d4ed8;color:#fff;text-decoration:none;padding:10px 20px;border-radius:8px;font-size:13px;font-weight:600">Open in Sympl</a>
  `);
}
